...
namespace AspNetCoreIdentity
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                //httponly=true olursa ilgili Cookie javascript aracýlýðýýyla çekilemiyor
                opt.Cookie.HttpOnly = true;
                //Samsite modunu strict ayaralarsam sadece ilgili domiende kullanýlabilir.
                opt.Cookie.SameSite = SameSiteMode.Strict;
                //alwayse derseniz sade http te çalýþsýn sameis request httpyle
